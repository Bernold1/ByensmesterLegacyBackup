...
<?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'addjQueryEvent'))) echo htmlspecialchars($t->addjQueryEvent("click","{{SHARP}}defineStep","jQuery.sitebuilder.sitebuilder.welcomeInfo(jQuery(this), \"{{SHARP}}defineStep\");"));?>
<?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'addjQueryEvent'))) echo htmlspecialchars($t->addjQueryEvent("click","{{SHARP}}StepInfoBar","jQuery.sitebuilder.sitebuilder.stepInfo(jQuery(this), \"{{SHARP}}StepInfoBar\");"));?>
...
<?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'addjQueryEvent'))) echo htmlspecialchars($t->addjQueryEvent("click",".jqTabMain","jQuery.sitebuilder.sitebuilder.basicSwitchTab(\"{{SHARP}}tableShortcut\",\"{{SHARP}}trShortCut\"+jQuery(this).attr(\"focusTarget\"));
jQuery.sitebuilder.sitebuilder.basicSwitchClass({id:\"{{SHARP}}nav\",defaultClass:\"jqTabMain\",findClass:\"activeme\",focusId:\"{{SHARP}}navS\"+jQuery(this).attr(\"focusTarget\")});
"));?>
...
<body <?php echo htmlspecialchars($t->templateBodyElements);?>>